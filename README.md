...
| exRule        | An exception rule to recurrence rule, commonly referred to as an EXRULE, defines a rule or repeating pattern for an exception to the recurrence set. | `EXRULE:FREQ=YEARLY;COUNT=8;BYMONTH=6,7`
| exDate        | The list of date/time exceptions for a recurring calendar component. | `EXDATE=19960402T010000Z,19960403T010000Z,19960404T010000Z`
